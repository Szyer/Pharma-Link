...
function AssignRoles() {
    ...
    return (
        <div className="container">
          <div className="address">
            <button className="btn btn-secondary m-4" onClick={redirect_to_home}>
              HOME
            </button>
            <span>
          ...
          <div>
            <h4 className="table-heading">Raw Material Suppliers:</h4>
          ...
          <div>
            <h4 className="table-heading">Manufacturer</h4>
            <table className="table table-striped">
              <thead>
                <tr>
                  <th scope="col">ID</th>
          ...
          <div>
            <h4       className="table-heading">Distributor</h4>
      <table className="table table-striped">
        <thead>
          <tr>
            <th scope="col">ID</th>
    ...
    <div>
      <h4 className="table-heading">Retailer</h4>
      <table className="table table-striped">
        <thead>
          <tr>
            <th scope="col">ID</th>
