    ...
    if (TrackTillSold) {
        return (
            <div className="container-xl">
                <article className="col-4 m-1 p-2">
                ...
                }} className="btn btn-success btn-sm m-2">Track Another Item</button>
                <span onClick={() => {
                    history.push('/')
                }} className="btn btn-secondary btn-sm m-2"> HOME</span>
            </div >
        )
    }
    if (TrackTillRetail) {
        return (
            <div className="container-xl">
                ...
                }} className="btn btn-success btn-sm">Track Another Item</button>
                <span onClick={() => {
                    history.push('/')
                }} className="btn btn-secondary btn-sm m-2"> HOME</span>
            </div >
    ...
    return (
        <div>
          <div className="address">
            <span onClick={redirect_to_home} className="btn btn-secondary btn-sm m-3">HOME</span>
          ...
          <div className="table">
            ...
            <h5 className="modern-heading">Enter Medicine ID to Track it</h5>

            <form className="modern-form" onSubmit={handlerSubmit}>
             <input className="modern-input" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
            <button className="modern-button" onSubmit={handlerSubmit}>Track</button>
           </form>
            </div>
